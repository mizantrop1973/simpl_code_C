...
{
public:
	void paintPoint(const Point&  point);       // в C++ обязательно выносить реализацию дружественных другим классам методов вне класса
...
void Human::paintPoint(const Point&  point)       //нарушается инкапсуляции, чтобы не нарушалась например надо передавать const ccылку
{
